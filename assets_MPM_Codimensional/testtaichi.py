...
# TODO：data化 preconditioner 加速 那些是可以用gridm>0来过滤的 
# TODO: 解决为什么cr误差降不下来问题 好奇乖？？为什么误差就是降不下来？？不然这么做就没有意义了 至少要每次降一个数量级才行
# TODO: 之前就有误差降不下来的问题 想办法搞定
# TODO：还有Matrixfree想办法搞定 框架出来了 很快就能搞定了

# TODO: 加levelset和attach
...
coef_Young = 5000.0 # E youngs modulus
coef_Poisson = 0.3 # eta Poisson ratio
coef_Visc = 5000.0 # viscous modulus
...
@ti.kernel
def substep_p2g_particles_type2():
    for p in ptclx:
...
@ti.kernel
def substep_p2g_particles_type3():
    for f in facex:
...
# TODO: 马上要上damping 这种damping只适用于explicit
@ti.kernel
...
def run_ggui():
    ...
    while window.running:
        ...
        for _ in range(n_substeps):
            ...
            substep_p2g_particles_type2()
            substep_p2g_particles_type3()
